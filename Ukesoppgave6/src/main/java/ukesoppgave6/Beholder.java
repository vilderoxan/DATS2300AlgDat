package ukesoppgave6;

import java.util.*;
import java.util.function.Predicate;

// En liste bak som holder på verdiene
// Dette er oppførselen til de som vil være en beholder. Hvordan den klassen
// velger å bruke en liste, eller en fil til å lagre verdien er ett fett
