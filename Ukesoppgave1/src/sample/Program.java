...
//e. Seksjon 1.1.10: oppgave 1
    /*
    	Utvid class Program og gjør om main-metoden slik som det bes om i Programkode
    	1.1.10. Kjør programmet!

    	Du kan endre tidsforbruket ved å endre tabellstørrelse og antall gjentagelser.
    	Lag f.eks. tabellen være dobbelt så stor (n = 200_000).
     */
...
class Program {
    ...
    public static void main(String[] args) {
        ...
        int antall = 2000;     // antall gjentagelser
